...
const menuItems = [
  ...
  { name: 'Danh mục', href: '/dashboard/categories', icon: 'M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z' },
  { name: 'Khuyến mãi', href: '/dashboard/discounts', icon: 'M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z' },
  { name: 'Tin tức', href: '/dashboard/posts', icon: 'M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z' },
];
