                    ...
                    <div className='col-span-6 m-[80px] justify-center flex'>
                        <div className=" w-full xl:max-w-md">
                            ...
                            <form>
                                ...
                                <p className="text-sm my-6" style={{ color: "var(--clr-txt-1)" }}>
                                    Bằng cách tạo tài khoản, bạn đồng ý với{" "}
                                    <a href="#" className=" hover:underline font-bold">Chính sách bảo mật</a> và{" "}
                                    <a href="#" className=" hover:underline font-bold">Chính sách truyền thông điện tử của chúng tôi.</a>
                                </p>
